...
/*
    ...
    and see what kind of error the compiler produces. Use the naming rules and conventions as a
    guide. In the program you created, try leaving the fields uninitialized and print out their values.
...
*/
	...
	// write your code here
        ...
        When compiled, we were given an error stating that it had an illegal start
        of expression.
            String thisString = ;
        ...
        /*
            ...
            This is because it didn't recognize the non-alphanumeric values, and couldn't read past that.
                int excitedNumber! = 1;
         */
